        ...
        public async Task<IActionResult> createPayment(CancellationToken cancellationToken, int auctionId)
        {
            try
            {
                ...
                string shortenedName = payment.nameAuction.Length > 20
                        ...
                        : payment.nameAuction;
                PaymentData paymentData = new PaymentData(payment.IdResgiter, payment.priceAuction, $"Thanh Toán {shortenedName}", items, "https://oas-fe.vercel.app/cancel", "https://oas-fe.vercel.app/success");
